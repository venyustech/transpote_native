          ...
          if (this.state.chat == true) {
            ...
            firebase.database().ref('chat' + '/' + this.getParamData.bokkingId + '/').update({
              ...
              this.sendPushNotification(
                this.state.carbookedInfo.driver,
                this.getParamData.bokkingId,
                `Rider ${this.state.carbookedInfo.customer_name} ${languageJSON.has_sent_message_to_you} \n ${inputmessage}`,
                // 'Rider ' + this.state.carbookedInfo.customer_name + ', has sent a messege to you: \n'+inputmessage)
              )
            })
          }
        } else {

...
import { traductionStatus } from '../utils';
        ...
        <ScrollView>
          <View style={styles.mapView}>
            <View style={styles.mapcontainer}>
              {this.state.intialregion && this.state.intialregion.latitude ?
              ...
              <View style={styles.userView}>
                <Text style={styles.textStyle}>
                  ...
                  {this.state.paramData && this.state.paramData.customer_paid
                    ? parseFloat(this.state.paramData.customer_paid).toFixed(2)
            ...
            <View style={styles.billView}>
              ...
              <View style={styles.billOptions}>
                <View style={styles.billItem}>
                  ...
                  {
                    //alert(JSON.stringify(this.state.paramData))
                  }
                  <Text style={styles.billAmount}>{this.state.settings.symbol} {this.state.paramData && this.state.paramData.proposal > 0 ? parseFloat(this.state.paramData.proposal).toFixed(2) : this.state.paramData && this.state.paramData.trip_cost > 0 ? parseFloat(this.state.paramData.trip_cost).toFixed(2) : this.state.paramData && this.state.paramData.estimate ? parseFloat(this.state.paramData.estimate).toFixed(2) : 0}</Text>
                </View>
                <View style={styles.billItem}>
                  <View>
                ...
                <View style={styles.billOptions}>
                  <View style={styles.billItem}>
                    ...
                    <Text style={styles.billAmount}>
                      {this.state.paramData.payment_status == "IN_PROGRESS" || this.state.paramData.payment_status == "WAITING"
                        ? "Aguardando Pagamento" : traductionStatus(this.state.paramData.payment_status ) }
                    </Text>
                  ...
                  <View style={styles.billItem}>
                    ...
                    <Text style={styles.billAmount}>
                      {this.state.paramData.payment_mode ? this.state.paramData.payment_mode : null}
                      {this.state.paramData.getway ? '(' + this.state.paramData.getway + ')' : null}
                    </Text>
                  </View>
                </View>
                : <View style={styles.billOptions}>
